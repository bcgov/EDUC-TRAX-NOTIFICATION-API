...
) LOB (EVENT_PAYLOAD) STORE AS EVENT_PAYLOAD (TABLESPACE API_TRAX_NOTIF_BLOB_DATA);

CREATE INDEX TRAX_NOTIFICATION_EVENT_EVENT_STATUS_IDX ON TRAX_NOTIFICATION_EVENT (EVENT_STATUS);
CREATE INDEX TRAX_NOTIFICATION_EVENT_EVENT_TYPE_IDX ON TRAX_NOTIFICATION_EVENT (EVENT_TYPE);
